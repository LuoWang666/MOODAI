<template>
  <div class="update-name">
    ...
    <div class="van-field-wrap">
      <van-field v-model.trim="localName" rows="2" autosize type="textarea" maxlength="10" placeholder="请输入昵称" show-word-limit />
    </div>
  </div>
</template>
  ...
  methods: {
    async onConfirm() {
      ...
      if (names.length > 0) {
        ...
        axios
          .post(
            'http://47.93.158.144:3000/my/userinfo/nickname',
            { nickname: names },
            {
              headers: {
